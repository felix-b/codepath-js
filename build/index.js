...
function createTreeGridView(table, columns) {
  ...
  var nodeSelectedCallback = undefined;
  ...
  var selectNode = function selectNode(index, node) {
    ...
    if (typeof index === "number" && index >= 0) {
      var _selectedTr = tbody.rows[index];
      _selectedTr.classList.add("selected");
      nodeSelectedCallback && nodeSelectedCallback(node);
      _selectedTr.scrollIntoViewIfNeeded(); //TODO
    }
  };
